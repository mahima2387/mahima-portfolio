...
const categories = [
  ...
  },
  {
    ...
    icon: { type: "image", src: `${import.meta.env.BASE_URL}logos/projects.png` },
  ...
  },
  {
    ...
    icon: { type: "image", src: `${import.meta.env.BASE_URL}logos/acm-w.png` },
  ...
  },
  {
    ...
    icon: { type: "image", src: `${import.meta.env.BASE_URL}logos/swmc.png` },
